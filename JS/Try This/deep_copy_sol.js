...
const deepCopy = (obj) => {
  if (obj === null || typeof obj !== "object" || obj instanceof WeakSet || obj instanceof WeakMap) return obj;
  ...
  if (obj instanceof Set) {
    ...
    [...obj.entries()].forEach(([_k, _v]) => copiedObj.set(deepCopy(_k), deepCopy(_v)));
    return copiedObj;
  }
...
console.log("Pass1?", kim.arr[0] !== newKim.arr[0] && kim.arr[3].aid !== newKim.arr[3].aid);
